...
def main():
    train_samples_file = open('data/train_samples.p', 'wb')
    train_labels_file = open('data/train_labels.p', 'wb')
    test_samples_file = open('data/test_samples.p', 'wb')
    test_labels_file = open('data/test_labels.p', 'wb')
